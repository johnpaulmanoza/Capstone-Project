...
extension Font {
    static func displayFont() -> Font {
        return Font.custom("MarkaziText-Medium", size: 42).weight(.medium)
    }
    ...
    static func regularText() -> Font {
        return Font.custom("Markazi-Regular", size: 18)
    }
    ...
    static func sectionCategories() -> Font {
        return Font.custom("Karla-Bold", size: 16)
    }
    ...
    static func highlightText() -> Font {
        return Font.custom("Karla-Medium", size: 14).weight(.medium)
    }
}
